...
public class SandwichDriver {
	...
	public static void main(String[] args) {
		...
		Customer customer = new Customer("Kate", "Smith", 20.32); //fN, lN, Cash
		Cashier cashier = new Cashier("Luke", "Prescott", 100.55); //fN, lN, Register Amount
		SandwichMaker cook = new SandwichMaker("John", "Doe", null); //fN, lN, current_orders
		...
		try {
			...
			System.out.println("\"\tI'm sorry, that is not enough money.\"");
			return;
			//System.out.println(e);
		}
		
		test_transaction.printReceipt();
